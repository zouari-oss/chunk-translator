# Contributing to chunk-translator

Thank you for your interest in contributing to chunk-translator! Contributions from the community are welcome and appreciated.
...
2. Clone your fork to your local machine:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/chunk-translator.git
   ```
...
Please check the [issues](https://github.com/chunk-translator/issues) tab to see where help is needed.
...
By contributing to chunk-translator, you agree that your contributions will be licensed under the same license as the project.
